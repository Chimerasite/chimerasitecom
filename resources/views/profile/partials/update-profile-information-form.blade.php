<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input.label class="text-gray-950" for="name" :value="__('Name')" />
        ...
        <div>
            <x-input.label class="text-gray-950" for="email" :value="__('Email')" />
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 text-gray-500">
                        ...
                        <button form="send-verification" class="underline text-sm text-gray-500 hover:text-blue-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
